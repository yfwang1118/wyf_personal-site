...
export const writingEn: WritingContent = {
  pageTitle: "Writing",
  intro:
    "This is not a flat archive. It is a second workspace for organizing technical thinking, applied notes, and literary writing, with enough structure for ideas to grow over time.",
  sections: {
    categories: "Writing themes",
  ...
  categories: [
    {
      ...
      description: "Structured writing on LLMs, agents, evaluation, capability measurement, and methodology."
    },
    {
      key: "applied-notes",
      title: "Applied Notes",
      description: "Writing that grows out of real systems, workflows, product constraints, and implementation problems."
    },
    {
      key: "literary-creation",
      title: "Literary Writing",
      description: "Fiction, essays, and fragments kept as a parallel long-running line of expression."
    }
  ],
  series: [
    {
